 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ue(e){return pe({...e,state:!0,attribute:!1})}let ge=class extends ae{constructor(){super(...arguments),this.selectedCategories=[]}static getStubConfig(){return{type:"custom:security-overview-card",title:"Security Overview",entities:[],devices:[],show_header:!0,show_compact_overview:!0,show_alarms:!0,show_locks:!0,show_doors:!0,show_windows:!0,show_motion:!0,show_cameras:!0,show_tamper:!1,category_selection_mode:"single",show_hidden_when_active:!1}}setConfig(e){if(!e)throw new Error("Invalid configuration");this.config={title:"Security Overview",show_header:!0,show_compact_overview:!0,show_alarms:!0,show_locks:!0,show_doors:!0,show_windows:!0,show_motion:!0,show_cameras:!0,show_tamper:!1,category_selection_mode:"single",show_hidden_when_active:!1,...e}}static async getConfigElement(){return await Promise.resolve().then(function(){return ye}),document.createElement("security-overview-card-editor")}render(){if(!this.config||!this.hass)return B``;const e=this.config.entities||[],t=this.config.devices||[];let i;i=this.selectedCategories.length>0?this._getEntitiesByCategories(e,t,this.selectedCategories):this._getSecurityEntities(e,t);const s=this._getAllSecurityEntities(e,t),o=this.config.max_height?`max-height: ${this.config.max_height};`:"",n=i.filter(e=>this._isEntityActive(e)),r=i.filter(e=>!this._isEntityActive(e));return B`
    ...
    `}_entityToggled(e,t){const i=e.target.checked;let s=[...this._config.entities||[]];i?s.includes(t)||s.push(t):s=s.filter(e=>e!==t);const o={...this._config,entities:s};me(this,"config-changed",{config:o})}_getAvailableDevices(){if(!this.hass)return[];const e=new Map;return Object.values(this.hass.states).forEach(t=>{const i=t.entity_id.split(".")[0];if(["alarm_control_panel","binary_sensor","lock","camera","sensor"].includes(i)&&(t.entity_id.includes("security")||t.entity_id.includes("alarm")||t.entity_id.includes("door")||t.entity_id.includes("window")||t.entity_id.includes("motion")||t.entity_id.includes("lock")||t.entity_id.includes("tamper")||"door"===t.attributes.device_class||"window"===t.attributes.device_class||"motion"===t.attributes.device_class||"opening"===t.attributes.device_class||"lock"===t.attributes.device_class||"safety"===t.attributes.device_class||"smoke"===t.attributes.device_class||"gas"===t.attributes.device_class||"tamper"===t.attributes.device_class)){let s=t.attributes.device_id;if(!s&&this.hass.devices){const e=Object.values(this.hass.entities||{}).find(e=>e.entity_id===t.entity_id);e&&(s=e.device_id)}if(!s){const e=(t.attributes.friendly_name||"").split(" ");s=e.length>1?e.slice(0,-1).join(" ").toLowerCase().replace(/\s+/g,"_"):`${i}_devices`}if(s){if(!e.has(s)){const i=this._getDeviceName(s,t);e.set(s,{id:s,name:i,entities:[]})}e.get(s).entities.push(t)}}}),Array.from(e.values()).map(e=>({id:e.id,name:e.name,entityCount:e.entities.length,entities:e.entities})).sort((e,t)=>e.name.localeCompare(t.name))}_getDeviceName(e,t){if(t.attributes.device_name)return t.attributes.device_name;if(e.endsWith("_devices")){return{alarm_control_panel:"Alarm Control Panels",lock:"Locks",binary_sensor:"Binary Sensors",camera:"Cameras",sensor:"Sensors"}[e.replace("_devices","")]||e}const i=(t.attributes.friendly_name||"").split(" ");if(i.length>1){return i.slice(0,-1).join(" ").replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}return e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}static get styles(){return r`
      .card-config {
        padding: 16px;
      }
