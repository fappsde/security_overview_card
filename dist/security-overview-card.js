 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ut(t){return pt({...t,state:!0,attribute:!1})}let _t=class extends at{static getStubConfig(){return{type:"custom:security-overview-card",title:"Security Overview",entities:[],show_header:!0}}setConfig(t){if(!t)throw new Error("Invalid configuration");this.config={title:"Security Overview",show_header:!0,...t}}static async getConfigElement(){return await Promise.resolve().then(function(){return $t}),document.createElement("security-overview-card-editor")}render(){if(!this.config||!this.hass)return V``;const t=this.config.entities||[],e=this._getSecurityEntities(t);return V`
      <ha-card .header="${this.config.show_header?this.config.title:void 0}">
        <div class="card-content">
          ${0===e.length?V`<p class="empty-state">No security entities configured</p>`:V`
                <div class="entities">
    ...
    `}};var gt,ft;t([pt({attribute:!1})],_t.prototype,"hass",void 0),t([ut()],_t.prototype,"config",void 0),_t=t([ht("security-overview-card")],_t),window.customCards=window.customCards||[],window.customCards.push({type:"security-overview-card",name:"Security Overview Card",description:"A card to display security-related entities in Home Assistant",preview:!0}),console.info("%c SECURITY-OVERVIEW-CARD %c 1.0.0 ","color: white; background: #1976d2; font-weight: 700;","color: #1976d2; background: white; font-weight: 700;"),function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(gt||(gt={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(ft||(ft={}));var mt=function(t,e,i,s){s=s||{},i=null==i?{}:i;var n=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return n.detail=i,t.dispatchEvent(n),n};let yt=class extends at{setConfig(t){this._config=t}render(){return this.hass&&this._config?V`
    ...
    `:V``}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target,i=e.configValue;if(!i)return;let s;if(s=void 0!==e.checked?e.checked:t.detail.value,this._config[i]===s)return;const n={...this._config,[i]:s};mt(this,"config-changed",{config:n})}_entityChanged(t){if(t.stopPropagation(),!this._config||!this.hass)return;const e=t.target.index,i=t.detail.value,s=[...this._config.entities||[]];s[e]=i;const n={...this._config,entities:s};mt(this,"config-changed",{config:n})}_addEntity(){const t=[...this._config.entities||[],""],e={...this._config,entities:t};mt(this,"config-changed",{config:e})}_removeEntity(t){const e=t.currentTarget.index,i=[...this._config.entities||[]];i.splice(e,1);const s={...this._config,entities:i};mt(this,"config-changed",{config:s})}static get styles(){return r`
      .card-config {
        padding: 16px;
      }
    ...
    `}};t([pt({attribute:!1})],yt.prototype,"hass",void 0),t([ut()],yt.prototype,"_config",void 0),yt=t([ht("security-overview-card-editor")],yt);var $t=Object.freeze({__proto__:null,get SecurityOverviewCardEditor(){return yt}});export{_t as SecurityOverviewCard};
