 ...
 */function ue(e){return pe({...e,state:!0,attribute:!1})}let ve=class extends ae{static getStubConfig(){return{type:"custom:security-overview-card",title:"Security Overview",entities:[],devices:[],show_header:!0,show_compact_overview:!0}}setConfig(e){if(!e)throw new Error("Invalid configuration");this.config={title:"Security Overview",show_header:!0,show_compact_overview:!0,...e}}static async getConfigElement(){return await Promise.resolve().then(function(){return ye}),document.createElement("security-overview-card-editor")}render(){if(!this.config||!this.hass)return B``;const e=this.config.entities||[],t=this.config.devices||[],i=this._getSecurityEntities(e,t),s=this.config.max_height?`max-height: ${this.config.max_height};`:"";return B`
    ...
    `}_valueChanged(e){if(!this._config||!this.hass)return;const t=e.target,i=t.configValue;if(!i)return;let s;if(s=void 0!==t.checked?t.checked:e.detail.value,this._config[i]===s)return;const o={...this._config,[i]:s};_e(this,"config-changed",{config:o})}_entityChanged(e){if(e.stopPropagation(),!this._config||!this.hass)return;const t=e.target.configValue,i=e.detail.value;if(null==i)return;const s=[...this._config.entities||[]];s[t]=i;const o={...this._config,entities:s};_e(this,"config-changed",{config:o})}_addEntity(){const e=[...this._config.entities||[],""],t={...this._config,entities:e};_e(this,"config-changed",{config:t})}_removeEntity(e){const t=e.currentTarget.index,i=[...this._config.entities||[]];i.splice(t,1);const s={...this._config,entities:i};_e(this,"config-changed",{config:s})}_deviceToggled(e,t){const i=e.target.checked;let s=[...this._config.devices||[]];i?s.includes(t)||s.push(t):s=s.filter(e=>e!==t);const o={...this._config,devices:s};_e(this,"config-changed",{config:o})}_isDeviceExpanded(e){return this._expandedDevices.has(e)}_toggleDeviceExpand(e){this._expandedDevices.has(e)?this._expandedDevices.delete(e):this._expandedDevices.add(e),this.requestUpdate()}_renderDeviceEntities(e){const t=e.entities||[],i=this._config.entities||[];return 0===t.length?B`
    ...
    `}_entityToggled(e,t){const i=e.target.checked;let s=[...this._config.entities||[]];i?s.includes(t)||s.push(t):s=s.filter(e=>e!==t);const o={...this._config,entities:s};_e(this,"config-changed",{config:o})}_getAvailableDevices(){if(!this.hass)return[];const e=new Map;return Object.values(this.hass.states).forEach(t=>{const i=t.entity_id.split(".")[0];if(["alarm_control_panel","binary_sensor","lock","camera","sensor"].includes(i)&&(t.entity_id.includes("security")||t.entity_id.includes("alarm")||t.entity_id.includes("door")||t.entity_id.includes("window")||t.entity_id.includes("motion")||t.entity_id.includes("lock")||"door"===t.attributes.device_class||"window"===t.attributes.device_class||"motion"===t.attributes.device_class||"opening"===t.attributes.device_class||"lock"===t.attributes.device_class||"safety"===t.attributes.device_class||"smoke"===t.attributes.device_class||"gas"===t.attributes.device_class)){let s=t.attributes.device_id;if(!s&&this.hass.devices){const e=Object.values(this.hass.entities||{}).find(e=>e.entity_id===t.entity_id);e&&(s=e.device_id)}if(!s){const e=(t.attributes.friendly_name||"").split(" ");s=e.length>1?e.slice(0,-1).join(" ").toLowerCase().replace(/\s+/g,"_"):`${i}_devices`}if(s){if(!e.has(s)){const i=this._getDeviceName(s,t);e.set(s,{id:s,name:i,entities:[]})}e.get(s).entities.push(t)}}}),Array.from(e.values()).map(e=>({id:e.id,name:e.name,entityCount:e.entities.length,entities:e.entities})).sort((e,t)=>e.name.localeCompare(t.name))}_getDeviceName(e,t){if(t.attributes.device_name)return t.attributes.device_name;if(e.endsWith("_devices")){return{alarm_control_panel:"Alarm Control Panels",lock:"Locks",binary_sensor:"Binary Sensors",camera:"Cameras",sensor:"Sensors"}[e.replace("_devices","")]||e}const i=(t.attributes.friendly_name||"").split(" ");if(i.length>1){return i.slice(0,-1).join(" ").replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}return e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}static get styles(){return r`
      .card-config {
        padding: 16px;
      }
